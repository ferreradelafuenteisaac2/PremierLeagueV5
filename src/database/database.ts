...
class DataBase {
    ...
    private _cadenaConexion:string= `mongodb+srv://admin:admin@cluster0.0gnym.mongodb.net/PremierEjemplo?retryWrites=true&w=majority`
    constructor(){
    ...
    conectarBD = async () => {
        const promise = new Promise<string>( async (resolve, reject) => {
            ...
            .catch( (error: any) => reject(`Error conectando a ${this._cadenaConexion}: ${error}`) ) 
        })
        return promise
    ...
    desconectarBD = async () => {
        ...
        const promise = new Promise<string>( async (resolve, reject) => {
            ...
            .catch( (error: any) => reject(`Error desconectando de ${this._cadenaConexion}: ${error}`) )     
        })
        return promise
    }
}
